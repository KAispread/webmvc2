...
//    @GetMapping("/")
    ...
    public String loginHome2(HttpServletRequest request, Model model) {
...
//    @GetMapping("/")
    public String loginHome3(HttpServletRequest request, Model model) {
...
//    @GetMapping("/")
    ...
    @GetMapping("/")
    public String loginHomeV5(@Login Member loginMember, Model model) {
        if (loginMember == null) {
            return "home";
        }
        model.addAttribute("member", loginMember);
